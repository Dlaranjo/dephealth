...
class RateLimitExceededError(APIError):
    ...
    def __init__(
        ...
        upgrade_url: str = "https://dephealth.laranjo.dev/pricing",
    ):
        super().__init__(
...
def error_response(
    ...
    Args:
        ...
        code: Error code string (e.g., "invalid_api_key")
...
def success_response(data: dict, status_code: int = 200, headers: dict = None) -> dict:
    """
